...
public class BoardDAO {
	...
	//쿼리등록
	private final String INSERT_BOARD = "INSERT INTO T_BOARD (BOARD_TITLE, BOARD_CONTENT, BOARD_WRITER) VALUES (?, ?, ?)";
	
	private final String GET_BOARD = "SELECT BOARD_NO, BOARD_TITLE, BOARD_CONTENT, BOARD_WRITER, BOARD_REGDATE, BOARD_CNT FROM T_BOARD WHERE BOARD_NO = ?";
	
	private final String UPDATE_BOARD = "UPDATE T_BOARD SET BOARD_TITLE = ?, BOARD_CONTENT = ?, BOARD_WRITER = ? WHERE BOARD_NO = ?";
